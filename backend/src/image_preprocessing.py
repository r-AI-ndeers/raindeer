...
def center_imgs(img, mask):
    img = cv2.copyMakeBorder(img, 300, 300, 300, 300, cv2.BORDER_CONSTANT, cv2.BORDER_CONSTANT)
    mask = cv2.copyMakeBorder(mask, 300, 300, 300, 300, cv2.BORDER_CONSTANT, cv2.BORDER_CONSTANT)
